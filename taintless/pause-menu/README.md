...
| Links                                                           | Description                            |
| --------------------------------------------------------------- | -------------------------------------- |
| 🛒 [**Purchase Now**](https://uzscripts.com/scripts/pause-menu) | Get the script from our official store |
